...
logActivity("Payment", "Processing booking with reference: " . $reference);

// Generate a unique transaction reference if one is not provided
if (empty($reference)) {
    $reference = 'MANUAL_' . uniqid() . '_' . time();
}

// Log successful verification
logActivity("Payment", "Manual payment processing for reference: " . $reference);
...
try {
    ...
    // Log activity
    logActivity("Booking", "Booking completed successfully with reference: " . $booking_reference);
