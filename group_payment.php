                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div class="bg-gradient-to-r from-primary-500 to-primary-700 p-6">
                        <h2 class="text-2xl font-bold text-white flex items-center">
                            ...
                            Secure Group Payment
                        </h2>
                        <p class="text-primary-100 mt-1">Complete your group booking with our secure payment gateway</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-6">
                    <div class="bg-gray-800 p-6">
                        <h2 class="text-xl font-bold text-white flex items-center">
                            <i class="fas fa-receipt mr-2"></i> Group Trip Summary
                        </h2>
                        <p class="text-gray-300 text-sm">Group Name: <span class="font-medium"><?php echo $group_name; ?></span></p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    paystackButton.addEventListener('click', function(e) {
        ...
        if (paystackButton.disabled) {
            return;
        }

        // Disable button to prevent multiple clicks
        paystackButton.disabled = true;
        paystackButton.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i><span class="font-medium">Processing...</span>';
        ...
        const handler = PaystackPop.setup({
            ...
            callback: function(response) {
                ...
                alert('Payment completed! Processing your group booking...');
                // Redirect to verification page
                window.location.href = 'group_paystack_callback.php?reference=' + response.reference;
            },
            onClose: function() {
                // Handle when the Paystack modal is closed
                console.log('Payment window closed');
                // Re-enable the button if payment was cancelled
                paystackButton.disabled = false;
                paystackButton.innerHTML = '<i class="fas fa-lock mr-2"></i><span class="font-medium">Pay Now with Paystack</span>';
            }
        });
